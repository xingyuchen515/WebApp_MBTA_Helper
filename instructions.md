...
- **Accessing the Form Data:** To access the form data, check out section *'The Request Object'* (<http://flask.pocoo.org/docs/1.0/quickstart/#the-request-object>) on using the Flask `request` utility.
